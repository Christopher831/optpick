const TRANSLATIONS = {
  en: {
    ...
    "demo-title": "Quick Demo Runs",
    "demo-ex3": "PDF Ex. 3 · n=8, k=6, j=4, s=4",
    "demo-ex4": "PDF Ex. 4 · n=9, k=6, j=4, s=4",
    "demo-ex8": "PDF Ex. 8 · n=10, k=6, j=6, s=4",
    "demo-ex9": "PDF Ex. 9 · n=12, k=6, j=6, s=4",
    "btn-execute": "Execute",
    "btn-clear": "Clear",
    ...
    "optimal-groups": "{num} optimal / near-optimal groups of {k}",
    "th-index": "#",
    ...
    "timeout-warning": "Algorithm timed out, returning the current best valid solution.",
    "new-best": "New best!",
  ...
  zh: {
    ...
    "demo-title": "快速演示",
    "demo-ex3": "PDF 示例 3 · n=8, k=6, j=4, s=4",
    "demo-ex4": "PDF 示例 4 · n=9, k=6, j=4, s=4",
    "demo-ex8": "PDF 示例 8 · n=10, k=6, j=6, s=4",
    "demo-ex9": "PDF 示例 9 · n=12, k=6, j=6, s=4",
    "btn-execute": "执行",
    "btn-clear": "清除",
    "btn-store": "保存到数据库",
    "btn-back": "返回",
    ...
    "optimal-groups": "{num} 个最优/近似最优分组（每组 {k} 个）",
    "th-index": "#",
    ...
    "timeout-warning": "算法超时，返回当前最好的有效解。",
    "new-best": "新纪录！",
